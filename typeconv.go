// Package typeconv provides fast, reflection-planned converters between Go types
// that share the same JSON tags. It avoids JSON marshal/unmarshal and aims to be
// as fast or faster than encoding/json for struct-to-struct mapping.
package typeconv
